...
HD_PWD='E:/ProjectCordic/vivado-design/cordic/cordic.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CORDICAtan2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CORDICAtan2.tcl -notrace
