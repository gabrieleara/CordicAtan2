...
HD_PWD='E:/ProjectCordic/vivado-design/cordic/cordic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CORDICAtan2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CORDICAtan2.tcl
